                ...
                <div class="col-md-12">
                    <div class="user-agreement" style="padding: 20px;">
                        ...
                        <p>
                            ...
                            this Agreement carefully before accepting.</p>

                        <p>The 'Winup360’ application and website www.Winup360.com is operated by Futuregenit, an entity set up for
                            Festivals and Retail Establishment for the purpose of operating and managing Winup360 (together referred
                            to as "Winup360", "we", "us", "our").</p>

                        <p>You, the user ("user", "you", "your") agree and understand that by clicking and accepting this User
                            Agreement, you confirm to have read, understood, and acknowledged to be bound by our terms to access and
                            use our Winup360 websites, and Winup360 App (together the "Platform").</p>

                        <p>This User Agreement and Privacy Policy (together the "Terms") set out the basis upon which you can access
                            ...
                            our Platform, either directly or through third-party sites.</p>
                        <p>Nothing in these Terms affects your statutory rights as a consumer under applicable laws.
                        </p>
                        <ul>
                            <li>
                                1. Winup360 APP
                                <ul>
                                    <li>
                                        <strong>1.1</strong> &nbsp; The following provisions apply with respect to your use of any version
                                        of the Winup360 App.
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>11.1 &nbsp; To the maximum extent permissible by applicable law, we, our group entities,
                                        subsidiaries
                                        and affiliates
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>16.1 &nbsp; The Terms shall be governed by and construed under the laws of the International
                                        Financial
                                        Corporation
                            ...
                            <li>
                                17. CONTACT
                                <ul>
                                    <li>17.1 &nbsp; You can contact us at: <span style="color: rgb(156, 238, 5); text-decoration: underline;">support@winup360.com</span></li>
                                </ul>
                            </li>
                            <li>
