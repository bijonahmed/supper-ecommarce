                ...
                <div class="col-md-12">
                    <div id="content-area" class="inner-page-wrapper" style="padding: 20px;">
                        ...
                        <div class="privacy-policy">
                            ...
                            <p>This Privacy Policy governs Personal Information we collect from users ("you" or "your") who visit our
                                website and use our applications and services ("Platform")</p>
                            <p>
                            ...
                            <p>You provide your consent to our processing of your Personal Information in accordance with this Privacy
                                Policy.</p>
                            <ul>
                                <li>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        Us an
                                        email at <span style="color: rgb(179, 255, 0);text-decoration: underline;">support@winup360.com</span>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        any of your data subject rights, please send a written request to <span style="text-decoration: underline; color: rgb(179, 255, 0);;">support@winup360.com</span>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li> We will retain your Personal Information for the length of time needed to fulfil the purposes outlined
