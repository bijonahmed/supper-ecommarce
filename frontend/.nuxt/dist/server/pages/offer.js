...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/offer.vue?vue&type=template&id=710e762e&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('Navbar'), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-xl-12\">", "</div>", [_vm._ssrNode("<div class=\"profile_right\">", "</div>", [_c('center', [_c('h1', [_vm._v("Welcome to WINUP360")])]), _vm._ssrNode(" <p>Where there's an experience of winning in online shopping! Our offer is unprecedented. For any product you purchase, you have the chance to win an extraordinary prize! Shop at WINUP360 and you could be blessed with invaluable blessings without waiting. Take a glimpse at our past winners and experience the joy of victory.</p> <p>All our draws are regulated by BANGLADESH economy and tourism. We take careful control of all draws for your confidence.</p> <p><strong>WINUP360 - where shopping and winning come together!</strong></p>")], 2)])])]), _vm._ssrNode(" "), _c('Footer'), _vm._ssrNode(" "), _c('MobileMenu')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/offer.vue?vue&type=template&id=710e762e&
