...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/verification.vue?vue&type=template&id=21b6177b&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  }) + ">" + _vm._ssrEscape(_vm._s(_vm.verifymsg)) + "</h3>" : "<!---->") + " <h3 class=\"fw-600 mb-4\">Validate OTP</h3> <p class=\"text- mb-4 text-light\">Please enter the OTP (one time password) to verify your\r\n                                    account. A Code has been sent to <span class=\"text-light\">your number.</span></p> <form id=\"otp-screen\" class=\"forms-sample\"><div bis_skin_checked=\"1\" class=\"row g-3\"><div bis_skin_checked=\"1\" class=\"col\"><input type=\"text\" maxlength=\"1\" autocomplete=\"off\"" + _vm._ssrAttr("value", _vm.insertdata.step1) + " class=\"form-control text-center text-6 py-2\"> " + (_vm.errors.step1 ? "<span class=\"text-danger\" style=\"font-size:10px ;\">" + _vm._ssrEscape(_vm._s(_vm.errors.step1[0])) + "</span>" : "<!---->") + "</div> <div bis_skin_checked=\"1\" class=\"col\"><input type=\"text\" maxlength=\"1\" autocomplete=\"off\"" + _vm._ssrAttr("value", _vm.insertdata.step2) + " class=\"form-control text-center text-6 py-2\"> " + (_vm.errors.step2 ? "<span class=\"text-danger\" style=\"font-size:10px ;\">" + _vm._ssrEscape(_vm._s(_vm.errors.step2[0])) + "</span>" : "<!---->") + "</div> <div bis_skin_checked=\"1\" class=\"col\"><input type=\"text\" maxlength=\"1\" autocomplete=\"off\"" + _vm._ssrAttr("value", _vm.insertdata.step3) + " class=\"form-control text-center text-6 py-2\"> " + (_vm.errors.step3 ? "<span class=\"text-danger\" style=\"font-size:10px ;\">" + _vm._ssrEscape(_vm._s(_vm.errors.step3[0])) + "</span>" : "<!---->") + "</div> <div bis_skin_checked=\"1\" class=\"col\"><input type=\"text\" maxlength=\"1\" autocomplete=\"off\"" + _vm._ssrAttr("value", _vm.insertdata.step4) + " class=\"form-control text-center text-6 py-2\"> " + (_vm.errors.step4 ? "<span class=\"text-danger\" style=\"font-size:10px ;\">" + _vm._ssrEscape(_vm._s(_vm.errors.step4[0])) + "</span>" : "<!---->") + "</div></div> <div bis_skin_checked=\"1\" class=\"d-grid my-4\"><button type=\"submit\" class=\"btn\" style=\"background-color: #b5f927;\">Verify</button></div></form></div></div></div></div></div></div></section> "), _c('Footer'), _vm._ssrNode(" "), _c('MobileMenu')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/verification.vue?vue&type=template&id=21b6177b&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/verification.vue?vue&type=script&lang=js&
/* harmony default export */ var verificationvue_type_script_lang_js_ = ({
  head: {
    title: 'Validate OTP'
  },
  data() {
  ...
  methods: {
    ...
    saveData() {
      ...
      this.$axios.post('/unauthenticate/verificationCode', formData, {
        headers
      }).then(response => {
...
// CONCATENATED MODULE: ./pages/verification.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_verificationvue_type_script_lang_js_ = (verificationvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/verification.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_verificationvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
