...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/login.vue?vue&type=template&id=0437d8ba&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  })], 2), _vm._ssrNode(" " + (_vm.errors.nationality_id ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.nationality_id[0])) + "</span>" : "<!---->") + " <span class=\"input-highlight\"></span>")], 2)]), _vm._ssrNode(" <div class=\"col-md-12\"><div class=\"input-container\">" + ((_vm.showRegPassword ? 'text' : 'password') === 'checkbox' ? "<input placeholder=\"Password\" type=\"checkbox\"" + _vm._ssrAttr("checked", Array.isArray(_vm.insertdata.password) ? _vm._i(_vm.insertdata.password, null) > -1 : _vm.insertdata.password) + " class=\"input-field\">" : (_vm.showRegPassword ? 'text' : 'password') === 'radio' ? "<input placeholder=\"Password\" type=\"radio\"" + _vm._ssrAttr("checked", _vm._q(_vm.insertdata.password, null)) + " class=\"input-field\">" : "<input placeholder=\"Password\"" + _vm._ssrAttr("type", _vm.showRegPassword ? 'text' : 'password') + _vm._ssrAttr("value", _vm.insertdata.password) + " class=\"input-field\">") + " <label for=\"input-field\" class=\"input-label\">Password </label> " + (_vm.errors.password ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.password[0])) + "</span>" : "<!---->") + " <span class=\"input-highlight\"></span> <i toggle=\"#password-field2\" class=\"fa-solid fa-eye toggle-password\"></i></div></div> <div class=\"col-md-12\"><div class=\"input-container\">" + ((_vm.showRegConPassword ? 'text' : 'password') === 'checkbox' ? "<input placeholder=\"Confirm Password\" id=\"password-field2\" type=\"checkbox\"" + _vm._ssrAttr("checked", Array.isArray(_vm.insertdata.password_confirmation) ? _vm._i(_vm.insertdata.password_confirmation, null) > -1 : _vm.insertdata.password_confirmation) + " class=\"input-field\">" : (_vm.showRegConPassword ? 'text' : 'password') === 'radio' ? "<input placeholder=\"Confirm Password\" id=\"password-field2\" type=\"radio\"" + _vm._ssrAttr("checked", _vm._q(_vm.insertdata.password_confirmation, null)) + " class=\"input-field\">" : "<input placeholder=\"Confirm Password\" id=\"password-field2\"" + _vm._ssrAttr("type", _vm.showRegConPassword ? 'text' : 'password') + _vm._ssrAttr("value", _vm.insertdata.password_confirmation) + " class=\"input-field\">") + " <label for=\"input-field\" class=\"input-label\">Confirm Password </label> " + (_vm.errors.password_confirmation ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.password_confirmation[0])) + "</span>" : "<!---->") + " <span class=\"input-highlight\"></span> <i toggle=\"#password-field2\" class=\"fa-solid fa-eye toggle-password\"></i></div></div> <div class=\"col-md-12\"><div class=\"input-container\"><input type=\"submit\" value=\"Submit\" class=\"btn_submit\"></div></div>")], 2)], 2)])])], 2)], 2)])])], 2), _vm._ssrNode(" "), _c('Footer'), _vm._ssrNode(" "), _c('MobileMenu')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/login.vue?vue&type=template&id=0437d8ba&
