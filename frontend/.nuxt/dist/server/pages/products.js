...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/products.vue?vue&type=template&id=74b44242&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  }), 0)])])])])]), _vm._ssrNode(" "), _vm._ssrNode("<section class=\"product\">", "</section>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-md-12\">", "</div>", [_vm.loading ? _vm._ssrNode("<span>", "</span>", [_c('Loader')], 1) : _vm._e(), _vm._ssrNode(" <h6>EXPLORE PRODUCTS</h6> <div class=\"p_filter\">" + _vm._ssrList(_vm.categories, function (item, index) {
    return "<button type=\"button\" class=\"btn_pfiler\">" + _vm._ssrEscape(_vm._s(item.name)) + "</button>";
  }) + "</div> "), _vm.imgloading ? _vm._ssrNode("<div>", "</div>", [_c('center', [_c('img', {
    staticClass: "rounded",
    staticStyle: {
      "height": "50px",
      "width": "50px"
  ...
  })])], 1) : _vm._e(), _vm._ssrNode(" "), _vm._l(_vm.groupedProducts, function (category, categoryName) {
    return _vm._ssrNode("<div>", "</div>", [_c('center', [_c('span', {
      staticStyle: {
        "color": "white",
        "text-align": "center"
      }
    }, [_vm._v(_vm._s(categoryName))])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"product_grid\">", "</div>", _vm._l(category, function (item, index) {
...
// CONCATENATED MODULE: ./pages/products.vue?vue&type=template&id=74b44242&
...
/* harmony default export */ var productsvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    groupedProducts() {
      ...
      const filteredGrouped = Object.fromEntries(Object.entries(grouped).filter(([key, value]) => value.length > 0));
