...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/LeftsidebarDesktop.vue?vue&type=template&id=7f845866&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<div class=\"profile_image\"><input type=\"file\" id=\"profile_img\" name=\"profile\" class=\"file-upload\"> <label for=\"profile_img\"><img src=\"/images/blank_profile.png\" width=\"100%\" loading=\"lazy\" alt class=\"img-fulid profile_pic\"></label> <h1>" + _vm._ssrEscape(_vm._s(_vm.insertdata.name)) + "</h1> <p>" + _vm._ssrEscape(_vm._s(_vm.insertdata.email)) + "</p></div> "), _vm._ssrNode("<div class=\"profile_links\">", "</div>", [_vm._ssrNode("<ul>", "</ul>", [_vm._ssrNode("<li>", "</li>", [_c('nuxt-link', {
    attrs: {
      "to": "/user/profile"
    }
  }, [_c('span', [_c('strong', {
...
// CONCATENATED MODULE: ./components/LeftsidebarDesktop.vue?vue&type=template&id=7f845866&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/LeftsidebarMobile.vue?vue&type=template&id=74668aff&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
// CONCATENATED MODULE: ./components/LeftsidebarMobile.vue?vue&type=template&id=74668aff&
...
var render = function render() {
  ...
  return _c('div', [_c('Navbar'), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"container desktop_view\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-xl-3\">", "</div>", [_c('LeftsidebarDesktop')], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-9\">", "</div>", [_vm._ssrNode("<div class=\"profile_right\">", "</div>", [_vm._ssrNode("<h1>Personal details</h1> "), _vm.loading ? _vm._ssrNode("<span>", "</span>", [_c('Loader')], 1) : _vm._e(), _vm._ssrNode(" "), _vm._ssrNode("<form id=\"userSubmitFrm\" enctype=\"multipart/form-data\" class=\"forms-sample\">", "</form>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-md-6\"><div class=\"input-container\"><input type=\"hidden\"" + _vm._ssrAttr("value", _vm.insertdata.id) + "> <input placeholder=\"First Name \" type=\"text\"" + _vm._ssrAttr("value", _vm.insertdata.fname) + " class=\"input-field\"> <label for=\"input-field\" class=\"input-label\">First Name </label> " + (_vm.errors.fname ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.fname[0])) + "</span>" : "<!---->") + " <span class=\"input-highlight\"></span></div></div> <div class=\"col-md-6\"><div class=\"input-container\"><input placeholder=\"Last Name \" type=\"text\"" + _vm._ssrAttr("value", _vm.insertdata.lname) + " class=\"input-field\"> <label for=\"input-field\" class=\"input-label\">Last Name </label> " + (_vm.errors.lname ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.lname[0])) + "</span>" : "<!---->") + " <span class=\"input-highlight\"></span></div></div> <div class=\"col-md-6\"><div class=\"input-container\"><input placeholder=\"Email\" type=\"text\"" + _vm._ssrAttr("value", _vm.insertdata.email) + " class=\"input-field\"> <label for=\"input-field\" class=\"input-label\">Email </label> " + (_vm.errors.email ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.email[0])) + "</span>" : "<!---->") + " <span class=\"input-highlight\"></span></div></div> <div class=\"col-md-6\"><div class=\"input-container\"><input placeholder=\"Date Of Birth\" onfocus=\"type='date'\" type=\"text\"" + _vm._ssrAttr("value", _vm.insertdata.date_of_birth) + " class=\"input-field\"> <label for=\"input-field\" class=\"input-label\">Date Of Birth</label> <span class=\"input-highlight\"></span></div></div> <div class=\"col-md-6\"><div class=\"input_group input-container\"><label for=\"nationality\" class=\"s_label\">Phone</label> <input placeholder=\"1700000000\" id=\"mobile_code\" type=\"text\"" + _vm._ssrAttr("value", _vm.insertdata.phone_number) + " class=\"input-field\"> " + (_vm.errors.phone_number ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.phone_number[0])) + "</span>" : "<!---->") + " <span class=\"input-highlight\"></span></div></div> "), _vm._ssrNode("<div class=\"col-md-6\">", "</div>", [_vm._ssrNode("<div class=\"input_group input-container\">", "</div>", [_vm._ssrNode("<label for=\"gender\" class=\"s_label\">Gender</label> "), _c('select', {
  ...
  })], 2)], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-md-6\">", "</div>", [_vm._ssrNode("<div class=\"input_group input-container\">", "</div>", [_vm._ssrNode("<label for=\"residence\" class=\"s_label\">Country Of Residence</label> "), _c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.insertdata.country_residence,
      expression: "insertdata.country_residence"
    }],
    staticClass: "form-control input-field",
    attrs: {
    ...
    on: {
      "change": function ($event) {
        ...
        _vm.$set(_vm.insertdata, "country_residence", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
      }
    }
  }, [_c('option', {
    attrs: {
  ...
  })], 2)], 2)]), _vm._ssrNode(" <div class=\"col-md-6\"><div class=\"input-container\"><input type=\"submit\" value=\"Update\" class=\"btn_submit\"></div></div>")], 2)])], 2)])], 2)]), _vm._ssrNode(" "), _c('LeftsidebarMobile'), _vm._ssrNode(" "), _c('Footer')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/user/profile.vue?vue&type=template&id=7ab8344e&
...
/* nuxt-component-imports */
installComponents(component, {Navbar: __webpack_require__(34).default,LeftsidebarDesktop: __webpack_require__(39).default,Loader: __webpack_require__(38).default,LeftsidebarMobile: __webpack_require__(42).default,Footer: __webpack_require__(32).default})
