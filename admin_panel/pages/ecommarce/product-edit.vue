                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="tab-content" id="pills-tabContent">
                                                ...
                                                <div class="tab-pane fade" id="image" role="tabpanel">
                                                    <div class="alert alert-info" bis_skin_checked="1"><i class="fas fa-info-circle"></i> Must Upload Products Images 393x491px</div>
                                                    <div class="row mb-3">
    ...
    methods: {
        ...
        productDetails() {
            ...
            this.$axios.get(`/product/productrow/${product_id}`).then(response => {
                ...
                // additional 
                console.log("------------------" + response.data.product_additional.referrance_product_id);
                // return false; 
