        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    ...
                    <div class="ms-auto">
                        <div class="btn-group">
                            <Nuxt-link to="/sliders/new-slider"><button type="button" class="btn btn-primary"><i class="bx bx-plus"></i>New</button></Nuxt-link>
                        </div>
                    </div>
                </div>
                <!--end breadcrumb-->
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control name" placeholder="Search... Slug" v-model="searchQuery.redirect_url" @input="handleSearch">
                                </div>
                            </div>
                            ...
                            <table class="table table-hover table-sm">
                                ...
                                <tbody>
                                    <tr v-for="item in paginatedData" :key="item.id">
                                        ...
                                        <td class="text-center"><img  :src="item.images" style="height:40px;width:40px; border-radius: 5px;"/></td>
    ...
    export default {
        ...
        computed: {
            ...
            filteredData() {
                ...
                if (this.searchQuery.redirect_url) {
                    result = result.filter(item =>
                        item.redirect_url.toLowerCase().includes(this.searchQuery.redirect_url.toLowerCase())
                    );
                }
        ...
        methods: {
            async fetchData() {
                ...
                try {
                    const response = await this.$axios.get(`/setting/slidersImages`);
